...
This project analyzes sales, customers, inventory, marketing campaigns, and web analytics data using SQL, MySQL, Python, and Power BI.
...
The project uses an enterprise-style e-commerce dataset containing:
